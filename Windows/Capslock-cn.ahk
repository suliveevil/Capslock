;====================================================================
;                   suliveevil 的 AHK 脚本
;             forked from   Feng Ruohang's AHK Script
;---------------------------------------------------------------------o
;说明:                                                                |
;    这个 AutoHotKey 提供了一个把一个使用频率低的大写锁定键增强为        |
; 可以和键盘上几乎其他所有按键搭配使用的超级功能键                       |
...
;|CapsLock + hjklwb     | Vim 风格的鼠标移动控制                       |
;|CaspLock + uiop       | Convient Home/End PageUp/PageDn             |
;|CaspLock + nm,.       | Convient 删除控制                           |
;|CapsLock + zxcvay     | Windows-Style Editor                       |
;|CapsLock + Direction  | 鼠标移动                                    |
;|CapsLock + Enter      | 鼠标点击                                    |
;|CaspLock + {F1}~{F6}  | 媒体音量控制                                |
;|CapsLock + qs         | Windows & Tags Control                      |
;|CapsLock + ;'[]       | Convient Key Mapping                        |
;|CaspLock + dfert      | Frequently Used Programs ( 自定义 )         |
;|CaspLock + 123456     | Dev-Hotkey for Visual Studio ( 自定义 )     |
