// Generated by TKG at 2019-04-16 19:53:17
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [1] = KEYMAP_TKG(
        ...
        TRNS,TRNS,TRNS,     TRNS,FN0, TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS),
    [2] = KEYMAP_TKG(
        ...
        TRNS,TRNS,0,   1,   2,   3,   TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
    ...
    [3] = KEYMAP_TKG(
        ...
        TRNS,TRNS,WH_L,WH_D,WH_U,WH_R,ACL2,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
        TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS),
    [4] = KEYMAP_TKG(
